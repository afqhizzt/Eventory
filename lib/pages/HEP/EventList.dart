...
class EventListPage extends StatelessWidget {
  final List<Event> events = [
    ...
    Event(index: 2, eventName: 'XtremeXperience', eventDate: DateTime.now().add(Duration(days: 1)), isChecked: false),
    Event(index: 3, eventName: 'TechTrek', eventDate: DateTime.now().add(Duration(days: 2)), isChecked: false),
    Event(index: 4, eventName: 'IdeaIgnite', eventDate: DateTime.now().add(Duration(days: 3)), isChecked: false),
    Event(index: 5, eventName: 'InnovateSphere', eventDate: DateTime.now().add(Duration(days: 4)), isChecked: false),
    Event(index: 6, eventName: 'MelodyFest', eventDate: DateTime.now().add(Duration(days: 5)), isChecked: false),
    Event(index: 7, eventName: 'HarmonyJam', eventDate: DateTime.now().add(Duration(days: 6)), isChecked: false),
    Event(index: 8, eventName: 'SonicSpectra', eventDate: DateTime.now().add(Duration(days: 7)), isChecked: false),
    ...
    Event(index: 11, eventName: 'DisruptDev', eventDate: DateTime.now().add(Duration(days: 10)), isChecked: true),
    Event(index: 12, eventName: 'ThinkTank', eventDate: DateTime.now().add(Duration(days: 11)), isChecked: true),
    Event(index: 13, eventName: 'ThriveRhythm', eventDate: DateTime.now().add(Duration(days: 12)), isChecked: true),
    Event(index: 14, eventName: 'Revolution', eventDate: DateTime.now().add(Duration(days: 13)), isChecked: true),
    Event(index: 15, eventName: 'BeatFusion', eventDate: DateTime.now().add(Duration(days: 14)), isChecked: true),
    Event(index: 16, eventName: 'AcousticAlchemy', eventDate: DateTime.now().add(Duration(days: 15)), isChecked: true),
    Event(index: 17, eventName: 'GrooveGala', eventDate: DateTime.now().add(Duration(days: 16)), isChecked: true),
    Event(index: 18, eventName: 'SymphonyShowdown', eventDate: DateTime.now().add(Duration(days: 17)), isChecked: true),
    Event(index: 19, eventName: 'PulsePalooza', eventDate: DateTime.now().add(Duration(days: 18)), isChecked: true),
